  ...
  nodes: [
    {
      ...
      data: {
        ...
        current_result_id: 'res_seed_shot1_current',
        results: [
          {
            id: 'res_seed_shot1_current',
            kind: 'image',
            url: 'https://picsum.photos/seed/shot1/512/288',
            thumbnail_url: 'https://picsum.photos/seed/shot1/512/288',
            title: '晨景当前结果',
            prompt: '城市天际线，晨光透过云层',
            provider: 'mock',
          ...
          {
            id: 'res_seed_shot1_old',
            kind: 'image',
            url: 'https://picsum.photos/seed/shot1-old/512/288',
            thumbnail_url: 'https://picsum.photos/seed/shot1-old/512/288',
            title: '晨景历史结果',
            prompt: '晨光旧版构图',
            provider: 'mock',
            source_type: 'canvas_generation',
