...
export type VideoReferenceCapabilities = {
  supportsStartAnchor: boolean;
  supportsEndAnchor: boolean;
  supportsMultipleIdentityRefs: boolean;
  supportsPrivateOrSignedUrl: boolean;
...
export interface VideoProviderAdapter {
  ...
  buildGenerateRequest(
    ...
    record: VideoGenerationProviderRecord,
