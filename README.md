...
当前产品版本为 `0.23.2`，下一版本规划为 `0.24.0`。`0.23.3` 的画布 AI 对话与镜头体验增强范围暂缓独立排期，按短剧项目中枢需要并入后续版本。后续版本线、当前版与上一版差异、下一版重点统一维护在 [docs/VERSION_PLAN.md](./docs/VERSION_PLAN.md)，当前版发布说明见 [RELEASES/0.23.2.md](./RELEASES/0.23.2.md)。
